document.addEventListener('DOMContentLoaded', () => {
    ...
    const PRODUCT_API_BASE_URL = process.env.PRODUCT_SERVICE_URL || 'http://localhost:8000';
    const ORDER_API_BASE_URL = process.env.ORDER_SERVICE_URL || 'http://localhost:8001';
    const CUSTOMER_API_BASE_URL = process.env.CUSTOMER_SERVICE_URL || 'http://localhost:8002';
